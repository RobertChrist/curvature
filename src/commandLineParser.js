...
var args = [
	...
	[ ['--' + setting.wayTypes.name],       	{ type: 'string', 	    defaultValue: setting.wayTypes.value, 	    help: 'a list of the highway types that should be included. The default is secondary,residential,tertiary,primary,primary_link,motorway,motorway_link,road,trunk,trunk_link,unclassified' }],
